 ...
 End IF
   ...
   ' new emp assign
    ...
    strBodyMax= " "
	    ...
	    SQL11 = "SELECT * FROM  Emp where Emp_Badge = '" & Badge & "'"
	    ...
	    IF NOT RS1.EOF THEN
            ...
            ISD_NameN = RS22("ISD_Name")
             ...
             strHead = "<html lang=""en""><head><meta http-equiv=""content-type"" content=""text/html; charset=iso-8859-1"" /></head>" & chr(13) &_
                     ...
                     "<br>Dear <b><i>"& Emp_name &" </i></b><br><br><br>This is the *** IT Asset Management System.<br>" & chr(13) &_
                     "I am sending you this email as a confirmation. A new update has been made in my records.<br><br>I have just added the following asset under your name: "
            strbody1 =" <b><i><font style=""color: #4477bb;""> "& ISD_NameN &"</font> </i></b>.<br><br>You now have the following assets:" & chr(13) &_
                     " <table><tbody><tr style=""font-family: 'Segoe UI Semilight', 'Open Sans', Verdana, Arial, Helvetica, sans-serif; font-weight: 500; font-size: 11pt; letter-spacing: 0.02em; line-height: 20px; padding: 3px 10px; border-right: 1px #ddd solid; border-bottom: 1px #ddd solid; box-sizing: border-box; background-color: #4477bb;  color:#ffffff;"" ><th >Type</th><th >ISD-Name</th><th >Assigning Date</th></tr>" 
    ...
    Else
        strBody = "Error in sending Email <br> No Asset <br> "
    END IF 
    
    strFoot = "<font style=""font-weight: 500; font-size: 9pt""><br> Note: This is an automated message. If you have not requested this change, or if you believe you have received this email by mistake, please call ext. 40640." & chr(13) &_
              ...
              "<tr style=""font-weight: 500; font-size: 8pt""><td colspan=""2"">System under evaluation</td></tr></table></body></html>"
